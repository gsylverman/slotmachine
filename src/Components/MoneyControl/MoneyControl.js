        ...
        return (
            ...
            <div className={classes.MoneyControl}>
                ...
                <input
                    ...
                    placeholder="Enter Amount" className={classes.amount} disabled={disabled} type="number" onChange={(e) => this.props.changeAmount(e.target.value)} value={this.props.amount}></input>
