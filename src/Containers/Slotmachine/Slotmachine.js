        ...
        return (
            <div className={classes.Slotmachine}>
                <Whiteband
                    ...
                    lista={lista1}
                    coloana={1}
                    actiune={this.props.porneste}
                    classes={`${classesWhite.Whiteband} ${classesWhite.Whiteband1}`}/>
                <Whiteband
                    started={this.props.started}
                    rez={l2}
                    lista={lista2}
                    coloana={2}
                    actiune={this.props.porneste}
                    classes={`${classesWhite.Whiteband} ${classesWhite.Whiteband2}`}/>
                <Whiteband
                    started={this.props.started}
                    rez={l3}
                    lista={lista3}
                    coloana={3}
                    actiune={this.props.porneste}
                    classes={`${classesWhite.Whiteband} ${classesWhite.Whiteband3}`}/>
            </div>
        );
    }
}
